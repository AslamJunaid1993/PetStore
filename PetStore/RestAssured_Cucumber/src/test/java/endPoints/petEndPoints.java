...
public class petEndPoints extends BaseEndPoints {
	...
	public static void addPet(World world) {
	...
	public static Response addPet(RequestSpecification request) {
		return addPet(request, getDefaultPet());
	}

	public static Response addPet(RequestSpecification request, Pet pet) {
		String url = getBaseUrl() + this.getPath();
