...
public class BaseEndPoints { public static final int SUCCESS_STATUS_CODE = 200;
...
public static RequestSpecification getRequestWithJSONHeaders() {
...
public static Response sendRequest(RequestSpecification request, int requestType, String url, Object pojo) {
